		...
		<div className="flex pt-5 md:pt-12 justify-center">
			<div className="bg-white md:h-96 w-11/12 md:w-7/10 md:mx-8 md:flex md:max-w-5xl shadow-lg rounded-lg">
				<div className="md:w-1/2 h-64 rounded-t-lg md:rounded-t-none md:rounded-tl-lg md:rounded-bl-lg md:h-auto overflow-hidden">
					<img alt='' id="dish-page-image" className="object-cover" src="../images/OreoCheesecakeBars.jpg" />
				...
				<div className="mb-4 pt-5 px-6 max-w-xl md:max-w-5xl md:w-1/2 specialfordish" >
					<h2 id="dish-page-name" className="text-3xl font-medium text-blue-600">Oreo Cheesecake Bars</h2>
					<span id="dish-page-prep-time" className="bg-green-400 text-gray-50 text-sm font-light rounded-md px-2 py-1">4 hours 5 minutes</span>
					<span id="dish-page-cuisine-type" className="bg-green-400 text-gray-50 text-sm font-light rounded-md px-2 py-1">Dessert</span>
					<p id="dish-page-ingredients" className="mt-4 text-gray-600 text-base font-regular">
						<span><li className="text-base font-regular">nonstick cooking spray</li></span>
						<span><li className="text-base font-regular">1 (19.1-ounce) package of Oreos®, divided</li></span>
						<span><li className="text-base font-regular">1/4 cup salted butter</li></span>
						<span><li className="text-base font-regular">3(8-ounce) packages cream cheese, softened</li></span>
                        <span><li className="text-base font-regular">1 cup sugar</li></span>
                        <span><li className="text-base font-regular">3/4 cup sour cream</li></span>
                        <span><li className="text-base font-regular">3 large eggs</li></span>
                        <span><li className="text-base font-regular">1 teaspoon vanilla extract</li></span>
                        <span><li className="text-base font-regular">1/4 teaspoon salt</li></span>
					</p>
				...
				<div className="pt-5 px-6 max-w-xl lg:max-w-5xl mb-4">
					<h2 className="text-2xl font-medium text-blue-600">Directions<span className="text-indigo-600"></span></h2>
					 <p id="dish-page-direction-text" className="mt-4 font-regular text-base">
						 ...
						 <br/><br/>
						 Line a 13x9x2-inch baking pan with heavy-duty foil, allowing 2 inches of overhang on two opposite sides of the pan. Coat foil lightly with nonstick cooking spray; set aside.
						 <br/><br/>
						 Place 30 cookies in a food processor. Cover and pulse until finely ground.
                         <br/><br/>
                         Add melted butter and pulse just until combined.
                         <br/><br/>
                         Transfer mixture to the prepared pan. Press crumbs evenly into the bottom of the pan.
                         <br/><br/>
                         ...
                         <br/><br/>
                         Coarsely crush the remaining oreos by placing them in a resealable bag and hitting it with a rolling pin.
                         <br/><br/>
                         Reserve 1/2 cup of the cookie crumbs. Fold the remaining crumbs into the batter.
                         <br/><br/>
                         Pour batter evenly over prebaked crust, smoothing the top as necessary.
                         <br/><br/>
                         Sprinkle with reserved cookie crumbs.
                         <br/><br/>
                         Bake in the preheated oven until the center appears set, with a slight jiggle, 35 to 40 minutes.
                         <br/><br/>
                         Cool in a pan on a wire rack for 2 hours, or until completely cool. Cover and chill for at least 1 hour.
                         <br/><br/>
                         Remove uncut bars from the pan by lifting foil.
                         <br/><br/>
                         Cut into 2x2-inch bars to serve.
					 </p>
